      ...
      <div className="services py-5 mt-5">
        <div className="container">
          <div className="services-section">
            <h2 className=' fw-bolder  pe-3 pe-lg-0 '>ا
              لخدمات</h2>
            ...
            <div className="all-services">
              <div className="row w-100 align-items-center justify-content-center">
                ...
                <div className="col-md-4 mt-lg-0 mt-4">
                  <div className="items text-center">
                    <img onClick={() => getData("مالية")} src='./images/finanziario-holding.webp' className={check1 ? 'w-100 mb-4 rounded-circle images' : 'w-100 mb-4 rounded-circle'} />
