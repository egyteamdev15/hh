                        ...
                        <div className="col-md-6 px-lg-0 px-sm-4 px-4">
                            <div className="items">
                                ...
                                <div className='mb-3'>
                                    ...
                                    <p className='fw-bolder text-black-50 mt-3 '>
                                        منح الالهام والابتكار لكل  صاحب مشروع يريد ان يرتقي بمشروعه الي  الاحترافية والمهنية المتميزة التي  لا مثيل لها مع توازن الجانب الانفاقي والتمويلي لكل مشروع وبما يتناسب مع متطلبات العملاء واحتياجاتهم وبما يساعدهم علي النمو والتوسع الرأسي والافقي في مجال استثمارهم
