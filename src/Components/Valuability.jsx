            ...
            <div data-aos="flip-right" className="col-lg-4 col-md-6 ">
              <div className="items text-center">
                ...
                <p className='fw-bolder text-black-50'>
                  نحترم كل  الجنسيات والأفكار المختلفة، كما أننا نتعامل بشفافية و نتحلى بالصدق في كلمات نقوم به لأننا نسعى في الاتجاه القويم بالطرق القويمة والإجراءات المستقيمة ونزين أعمالنا.في إطار من الأخلاق والقيم والاعتبارات القانونية.
                </p>
              </div>
            </div>
